...
# ex: bash SZ_TNG.sh 0 28 24 10001 True
...
# command line flags are: latin hypercube number (lh), initial snapshot number (si), final snapshot number (sf), number of bins for maps (nb), save map condition (sm)
...
python3 /global/homes/k/kjc268/SZ_TNG/apply_beam.py -lh $1 -si $2 -sf $3 -nb $4 -sm $5